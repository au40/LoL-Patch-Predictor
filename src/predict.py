...
# Only truly-consecutive pairs with win-rate data on both sides; the 15.4/15.9 win-rate gaps
# and 15.2/15.3 (no patch notes) are skipped so a boundary never spans two patches.
DEFAULT_BOUNDARIES = [
